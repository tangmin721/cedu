...
import com.yanxiu.ce.core.basic.dao.TeacherPayDao;
 ...
 */
@Service("teacherPayService")
public class TeacherPayServiceImpl extends BaseServiceImpl<TeacherPay, TeacherPayQuery> implements TeacherPayService{
	@Autowired
	private TeacherPayDao dao;

	@Override
	protected BaseDao<TeacherPay, TeacherPayQuery> dao() {
		return this.dao;
	}
	 ...
	 */
	@Override
	public Boolean checkNameExit(TeacherPay entity) {
	...
	@Override
	@Transactional
	public String saveOrUpdate(TeacherPay entity) {
