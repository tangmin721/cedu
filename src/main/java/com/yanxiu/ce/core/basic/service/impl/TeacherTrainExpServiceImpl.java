...
import com.yanxiu.ce.core.basic.dao.TeacherTrainExpDao;
 ...
 */
@Service("teacherTrainExpService")
public class TeacherTrainExpServiceImpl extends BaseServiceImpl<TeacherTrainExp, TeacherTrainExpQuery> implements TeacherTrainExpService{
	@Autowired
	private TeacherTrainExpDao dao;

	@Override
	protected BaseDao<TeacherTrainExp, TeacherTrainExpQuery> dao() {
		return this.dao;
	}
	 ...
	 */
	@Override
	public Boolean checkNameExit(TeacherTrainExp entity) {
...
//		}
	...
	@Override
	@Transactional
	public String saveOrUpdate(TeacherTrainExp entity) {
	...
	@Override
	@Transactional
	public String saveTrainExps(List<TeacherTrainExp> exps) {
		if(exps.size()>0){
			//第一步，根据tid删除exps
	...
	public Long deleteByPid(Long pid) {
		return this.dao.deleteByPid(pid);
	}
