...
import com.yanxiu.ce.core.basic.dao.TeacherCredentAttDao;
 ...
 */
@Service("teacherCredentAttService")
public class TeacherCredentAttServiceImpl extends BaseServiceImpl<TeacherCredentAtt, TeacherCredentAttQuery> implements TeacherCredentAttService{
	@Autowired
	private TeacherCredentAttDao dao;

	@Override
	protected BaseDao<TeacherCredentAtt, TeacherCredentAttQuery> dao() {
		return this.dao;
	}
	 ...
	 */
	@Override
	public Boolean checkNameExit(TeacherCredentAtt entity) {
...
//		}
	...
	@Override
	@Transactional
	public String saveOrUpdate(TeacherCredentAtt entity) {
