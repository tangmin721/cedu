...
import com.yanxiu.ce.core.basic.dao.TeacherSubjectStudyDao;
 ...
 */
@Service("teacherSubjectStudyService")
public class TeacherSubjectStudyServiceImpl extends BaseServiceImpl<TeacherSubjectStudy, TeacherSubjectStudyQuery> implements TeacherSubjectStudyService{
	@Autowired
	private TeacherSubjectStudyDao dao;

	@Override
	protected BaseDao<TeacherSubjectStudy, TeacherSubjectStudyQuery> dao() {
		return this.dao;
	}
	 ...
	 */
	@Override
	public Boolean checkNameExit(TeacherSubjectStudy entity) {
...
//		}
	...
	@Override
	@Transactional
	public String saveOrUpdate(TeacherSubjectStudy entity) {
