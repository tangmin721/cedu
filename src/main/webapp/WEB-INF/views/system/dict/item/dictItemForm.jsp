...
function refushDictItemTable(json){
...
<div class="bjui-pageContent">
    <form action="${ctx}/system/dict/item/saveDictItem" id="f_dict_item_form" method="post" data-toggle="validate" data-alertmsg="false" data-callback="refushDictItemTable">
