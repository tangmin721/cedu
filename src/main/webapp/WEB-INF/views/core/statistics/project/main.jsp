...
var pieChart = echarts.init(document.getElementById('report_project_charts'));
...
<div class="bjui-pageHeader">
    <form id="pagerForm" class="config_pager_form" data-toggle="ajaxsearch" action="${ctx}/core/statistics/project/main" method="post" data-reload-navtab="true">
        ...
        <div class="bjui-searchBar pull-right">
        	<shiro:hasAnyRoles name="SUP_ADMIN,SYS_ADMIN,PROVINCE_ADMIN,CITY_ADMIN,TOWN_ADMIN,SCHOOL_ADMIN">
            	<div <c:if test="${sessionScope.currentUser.province==0}">style="display: inline;"</c:if><c:if test="${sessionScope.currentUser.province!=0}">  style="display: none;" </c:if>>
             	...
             	data-nextselect="#r_project_list_sform_city"  data-refurl="${ctx}/system/area/city/citys?province={value}" data-size="20" data-width="140px">
        		...
        		<select name="city" id="r_project_list_sform_city" data-toggle="selectpicker" 
        			 data-nextselect="#r_project_list_sform_town" 
	            ...
	            <select name="town" id="r_project_list_sform_town" data-toggle="selectpicker" 
	            	data-nextselect="#r_project_list_sform_school" 
            ...
            <button type="submit" class="btn btn-blue" id="r_project_search" data-icon="search">查询</button>&nbsp;
...
<div class="bjui-pageContent tableContent">
    ...
    <div class="wrapdiv4" style="height:100%;">
        <div id="report_project_charts" class="contentdiv4"></div>
    </div>
</div>
