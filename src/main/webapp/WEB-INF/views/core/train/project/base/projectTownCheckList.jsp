...
//区县审批
function townCheckForm(pid){
	$(this).dialog({id:'np-town-check-form', url:'${ctx}/core/train/project/base/townCheckProjectForm/'+pid, type:'POST',title:'审批校级项目',mask:'true',width:'560',height:'180'});
}
...
<div class="bjui-pageHeader">
	<form id="pagerForm" class="project_pager_form"
		...
		action="${ctx}/core/train/project/base/townCheckList"
					...
					<shiro:hasAnyRoles name="SCHOOL_ADMIN">
						<td>
							<c:if test="${item.cstatus ==11}">
								...
								<span class="label label-danger">审批不通过.</span>
							</c:if> 
						</td>
					</shiro:hasAnyRoles>
					<shiro:hasAnyRoles name="TOWN_ADMIN">
