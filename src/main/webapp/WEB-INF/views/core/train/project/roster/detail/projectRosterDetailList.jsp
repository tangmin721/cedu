...
$('#but_project_roster_detail_add').on('click', function(e) {
	$(this).dialog({id:'project_roster_detail_form', url:'${ctx}/core/basic/teacher/base/teacherSelectList/0', onClose:function(){
		$('#apply_detail_search').trigger('click');
	},type:'POST',title:'选择教师',mask:'true',max:'true',width:'560',height:'500'});
});
...
<div class="bjui-pageHeader">
	<div class="btn-group pull-left" role="group">
		<shiro:hasPermission name="ProjectRosterDetail:create">
			<button type="button" id="but_project_roster_detail_add" class="btn btn-blue" data-icon="plus-circle" >添加教师</button>
		</shiro:hasPermission>
		<shiro:hasPermission name="ProjectRosterDetail:delete">
			<button type="button" id="but_project_roster_detail_delete" class="btn btn-red" data-icon="times-circle" >删除</button>
		</shiro:hasPermission>
	</div>
    <form id="pagerForm" class="project_roster_detail_pager_form" data-toggle="ajaxsearch" action="${ctx}/core/train/project/roster/detail/projectRosterDetailList/${applyId}" method="post" data-reload-navtab="true">
