    ...
    <form action="${ctx}/core/score/adminUpdateScore" id="f_score_form" method="post" data-toggle="validate" data-alertmsg="false" data-callback="adminRefushScoreTable">
        ...
        <table class="table table-condensed table-hover" style="width:100%;margin-top:-1px;">
            <tbody>
                ...
                <tr>
                    <td>
                        <label class="control-label x100"><span class="red">*</span>级别：</label>
                ...
                <tr>
                 ...
                 <tr>
                    <td>
                        <label class="control-label x100">课题名称：</label>
                        ${entity.name }
                    </td>
                </tr>
                 <tr>
                     <td>
                         <label class="control-label x100"><span class="red">*</span>交流时长：</label>
                         ${entity.pnum }
                     </td>
                 </tr>
                 <tr>
