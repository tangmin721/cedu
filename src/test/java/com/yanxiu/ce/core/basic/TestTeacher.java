 ...
 * @date 2016年8月22日
 */
public class TestTeacher extends SpringJunitTest{

	@Autowired
	private TeacherMovePojoService teacherMovePojoService;

	@Autowired
	private TeacherMovePojoDao teacherMovePojoDao;
...
//			}
	...
	public static void main(String[] args) {
		Date randomDate = randomDate(1950,50);
...
//		TeacherMovePojoQuery query= new TeacherMovePojoQuery();
//		query.setPageSize(10l);
//		teacherMovePojoService.selectListPagination(query);

		TeacherMovePojoQuery query= new TeacherMovePojoQuery();
		teacherMovePojoDao.selectListTotal(query);
	}
}
